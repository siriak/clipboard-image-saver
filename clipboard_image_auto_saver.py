...
if os.name == 'posix':
    from linux_infrastructure import is_image_in_clipboard, get_image_from_clipboard, get_pixels_from_image, save_image, show_notification
elif os.name == 'nt':
    from windows_infrastructure import is_image_in_clipboard, get_image_from_clipboard, get_pixels_from_image, save_image, show_notification
else:
    pass
